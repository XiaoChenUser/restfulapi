...
@Entity
@Table(name = "aircondition_outerunittable")
public class AirOuterUnit implements Serializable{
    @Id                           //主键配置

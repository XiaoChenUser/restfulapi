...
@Entity
@Table(name = "aircondition_historyouterstatustable")
public class AirRealOuterStatus implements Serializable{
    @Id                           //主键配置

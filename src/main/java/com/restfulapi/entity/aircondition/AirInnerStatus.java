...
@Entity
@Table(name = "aircondition_innerstatustable")
public class AirInnerStatus implements Serializable{
    @Id                           //主键配置

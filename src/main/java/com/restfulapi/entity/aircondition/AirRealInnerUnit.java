...
@Entity
@Table(name = "aircondition_historyinnerunittable")
public class AirRealInnerUnit implements Serializable{
    @Id                           //主键配置

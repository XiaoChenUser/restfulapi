...
@Entity
@Table(name = "aircondition_historyouterunittable")
public class AirRealOuterUnit implements Serializable{
    @Id                           //主键配置

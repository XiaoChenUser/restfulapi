...
@Entity
@Table(name = "aircondition_deviceinfotable")
public class AirDevice implements Serializable {
    ...
    public AirDevice(String ip, String mac, String mid, String country, String province, String city, String codes, String evt) {
        this.ip = ip;
        this.mac = mac;
        this.mid = mid;

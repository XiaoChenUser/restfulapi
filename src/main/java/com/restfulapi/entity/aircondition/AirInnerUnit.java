...
@Entity
@Table(name = "aircondition_innerunittable")
public class AirInnerUnit implements Serializable{
    @Id                           //主键配置

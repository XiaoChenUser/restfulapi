...
@Entity
@Table(name = "dehumidifier_historyouterunittable")
public class DehumidifierRealOuterUnit implements Serializable{
    @Id                           //主键配置
    ...
    public DehumidifierRealOuterUnit() {

    }

    public DehumidifierRealOuterUnit(String mac, Date ctime, String txbb, String txsd, String lnjx, String bpdp, String wjnldm, String gdfs, String dyzl, String swjlx, String ysjxh, String cflx, String fjzl, String fjgs, String fjds, String dplnqyrdyw, String ysjyrdyw, String xqzyryw, String dzpzfyw, String jxm, String wfjipmmk, String ysjipmmk, String njcxbbh, String wjcxbbh) {
        this.mac = mac;
        this.ctime = ctime;
        this.txbb = txbb;
        this.txsd = txsd;

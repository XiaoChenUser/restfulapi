...
@Entity
@Table(name = "dehumidifier_historyinnerunittable")
public class DehumidifierRealInnerUnit implements Serializable{
    @Id                           //主键配置

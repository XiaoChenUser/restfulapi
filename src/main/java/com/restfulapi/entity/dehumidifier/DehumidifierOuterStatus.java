...
@Entity
@Table(name = "dehumidifier_outerstatustable")
public class DehumidifierOuterStatus implements Serializable{
    @Id                           //主键配置

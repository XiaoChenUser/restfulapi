...
@Entity
@Table(name = "dehumidifier_historyinnerstatustable")
public class DehumidifierRealInnerStatus implements Serializable{
    @Id                           //主键配置

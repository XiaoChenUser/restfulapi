...
@Entity
@Table(name = "dehumidifier_historyouterstatustable")
public class DehumidifierRealOuterStatus implements Serializable{
    @Id                           //主键配置
